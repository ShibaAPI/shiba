...
def test_get_new_sales(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getnewsales.xml")
    )
...
def test_accept_sale(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_accept_sale.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_get_current_sales(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getcurrentsales.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_get_billing_information(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getbillinginformation.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_get_shipping_information(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getshippinginformation.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_get_items_todo_list(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getitemtodolist.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_get_item_infos(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_getiteminfos.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_contact_user_about_item(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_contactuser.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_set_tracking_package_infos(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_settrackingpackageinfos.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
...
def test_confirm_preorder(monkeypatch):
    ...
    monkeypatch.setattr(
        "requests.get", make_requests_get_mock("sample_confirmpreorder.xml")
    )
    sales_management = SalesManagement(
        ShibaConnection("test", "test", "https://ws.fr.shopping.rakuten.com")
    )
